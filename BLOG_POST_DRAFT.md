...
I built **[llm-prices](https://github.com/benbencodes/llm-prices)**: a zero-dependency Python CLI that lets you query, compare, and calculate LLM API costs across 144 models from 22 providers. In this post I'll share the most interesting data I've found, and show you how to use the tool in your own workflows.
