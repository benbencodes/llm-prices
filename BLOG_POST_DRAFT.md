...
I built **[llm-prices](https://github.com/benbencodes/llm-prices)**: a zero-dependency Python CLI that lets you query, compare, and calculate LLM API costs across 138 models from 22 providers. In this post I'll share the most interesting data I've found, and show you how to use the tool in your own workflows.
...
Current coverage: **138 models, 22 providers** — including OpenAI, Anthropic, Google, Mistral, DeepSeek, Groq, xAI, Moonshot, Hyperbolic, Crusoe, Nebius, Lambda, and more.
